...
Opal.modules["asciidoctor/opal_ext/file"] = function(Opal) {
  ...
  (function($base) {
    ...
    Opal.defn(self, '$open', TMP_1 = function(path) {
      var $a, $b, self = this, $iter = TMP_1.$$p, $yield = $iter || nil, file = nil, $splat_index = nil;

      var array_size = arguments.length - 1;
      if(array_size < 0) array_size = 0;
      var rest = new Array(array_size);
      for($splat_index = 0; $splat_index < array_size; $splat_index++) {
        rest[$splat_index] = arguments[$splat_index + 1];
      }
      TMP_1.$$p = null;
...
/* Generated by Opal 0.9.2 */
Opal.modules["asciidoctor/opal_ext/defold"] = function(Opal) {
  Opal.dynamic_require_severity = "ignore";
  var OPAL_CONFIG = { method_missing: true, arity_check: false, freezing: true, tainting: true };
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;

  Opal.add_stubs(['$[]', '$attributes', '$document', '$node_name']);
  return (function($base, $super) {
    function $Defold(){};
    var self = $Defold = $klass($base, $super, 'Defold', $Defold);

    var def = self.$$proto, $scope = self.$$scope;

    return (Opal.defs(self, '$render', function(node) {
...
Opal.modules["asciidoctor/opal_ext"] = function(Opal) {
  ...
  self.$require("asciidoctor/opal_ext/defold");
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$read_parse', function() {
        ...
        if ((($a = $rb_gt((time = $rb_plus((((($b = self.log['$[]']("read")) !== false && $b !== nil) ? $b : 0)), (((($b = self.log['$[]']("parse")) !== false && $b !== nil) ? $b : 0)))), 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return time
          } else {
          return nil
        };
      ...
      Opal.defn(self, '$read_parse_convert', function() {
        ...
        if ((($a = $rb_gt((time = $rb_plus($rb_plus((((($b = self.log['$[]']("read")) !== false && $b !== nil) ? $b : 0)), (((($b = self.log['$[]']("parse")) !== false && $b !== nil) ? $b : 0))), (((($b = self.log['$[]']("convert")) !== false && $b !== nil) ? $b : 0)))), 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return time
          } else {
          return nil
        };
      ...
      Opal.defn(self, '$total', function() {
        ...
        if ((($a = $rb_gt((time = $rb_plus($rb_plus($rb_plus((((($b = self.log['$[]']("read")) !== false && $b !== nil) ? $b : 0)), (((($b = self.log['$[]']("parse")) !== false && $b !== nil) ? $b : 0))), (((($b = self.log['$[]']("convert")) !== false && $b !== nil) ? $b : 0))), (((($b = self.log['$[]']("write")) !== false && $b !== nil) ? $b : 0)))), 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return time
          } else {
          return nil
        };
          ...
          m = $gvars["~"];
            ...
            if ((($a = ((boundary = m['$[]'](4)))['$nil_or_empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              ...
              if (attributes !== false && attributes !== nil) {
                if ((($a = $rb_gt(escape_count, 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
              ...
              } else if ((($a = $rb_gt(escape_count, 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
                return "" + (m['$[]'](1)) + "[" + (attributes) + "]" + ($rb_times("\\", ($rb_minus(escape_count, 1)))) + (boundary) + (m['$[]'](5)) + (boundary);};
...
if (line == null) line = nil;
        reject = false;
          ...
          if ((($a = line['$include?']("{")) !== nil && (!$a.$$is_boolean || $a == true))) {
            line = ($a = ($b = line).$gsub, $a.$$p = (TMP_17 = function(){var self = TMP_17.$$s || this, $a, $b, $c, m = nil, offset = nil, directive = nil, expr = nil, $case = nil, args = nil, _ = nil, value = nil, val = nil, key = nil;
              if (self.document == null) self.document = nil;
              if ($gvars["~"] == null) $gvars["~"] = nil;
            ...
            m = $gvars["~"];
              if ((($a = ((($b = m['$[]'](1)['$==']("\\")) !== false && $b !== nil) ? $b : m['$[]'](4)['$==']("\\"))) !== nil && (!$a.$$is_boolean || $a == true))) {
                ...
                $b = $scope.get('Parser').$store_attribute(args['$[]'](0), ((($c = args['$[]'](1)) !== false && $c !== nil) ? $c : ""), self.document), $a = Opal.to_ary($b), _ = ($a[0] == null ? nil : $a[0]), value = ($a[1] == null ? nil : $a[1]), $b;
...
if (it == null) it = nil;
          ...
          if ((($a = ($d = result['$include?']("\""), $d !== false && $d !== nil ?result['$include?']("&gt;") : $d)) !== nil && (!$a.$$is_boolean || $a == true))) {
            result = ($a = ($d = result).$gsub, $a.$$p = (TMP_22 = function(){var self = TMP_22.$$s || this, $a, $b, $c, $d, TMP_23, m = nil, captured = nil, input = nil, menu = nil, submenus = nil, menuitem = nil;
              if ($gvars["~"] == null) $gvars["~"] = nil;
            ...
            m = $gvars["~"];
              if ((($a = ((captured = m['$[]'](0)))['$start_with?']("\\")) !== nil && (!$a.$$is_boolean || $a == true))) {
                return captured['$[]']($range(1, -1, false));};
              input = m['$[]'](1);
              $b = ($c = ($d = input.$split("&gt;")).$map, $c.$$p = (TMP_23 = function(it){var self = TMP_23.$$s || this;
if (it == null) it = nil;
              return it.$strip()}, TMP_23.$$s = self, TMP_23), $c).call($d), $a = Opal.to_ary($b), menu = ($a[0] == null ? nil : $a[0]), submenus = $slice.call($a, 1), $b;
              menuitem = submenus.$pop();
        ...
        if ((($a = ($k = found['$[]']("macroish_short_form"), $k !== false && $k !== nil ?result['$include?']("footnote") : $k)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          m = $gvars["~"];
            ...
            if (m['$[]'](1)['$==']("footnote")) {
              ...
              $b = m['$[]'](2).$split(",", 2), $a = Opal.to_ary($b), id = ($a[0] == null ? nil : $a[0]), text = ($a[1] == null ? nil : $a[1]), $b;
              id = id.$strip();
...
if (fn == null) fn = nil;
      ...
      Opal.defn(self, '$sub_inline_xrefs', function(text, found) {
        ...
        if ((($a = ((($b = (((($c = found['$!']()) !== false && $c !== nil) ? $c : found['$[]']("macroish")))) !== false && $b !== nil) ? $b : text['$include?']("&lt;&lt;"))) !== nil && (!$a.$$is_boolean || $a == true))) {
          text = ($a = ($b = text).$gsub, $a.$$p = (TMP_35 = function(){var self = TMP_35.$$s || this, $a, $b, $c, $d, TMP_36, $e, m = nil, id = nil, reftext = nil, path = nil, fragment = nil, refid = nil, target = nil, resolved_id = nil;
            if (self.document == null) self.document = nil;
            if ($gvars["~"] == null) $gvars["~"] = nil;
          ...
          m = $gvars["~"];
            ...
            if ((($a = m['$[]'](1)) !== nil && (!$a.$$is_boolean || $a == true))) {
              $b = ($c = ($d = m['$[]'](1).$split(",", 2)).$map, $c.$$p = (TMP_36 = function(it){var self = TMP_36.$$s || this;
if (it == null) it = nil;
              return it.$strip()}, TMP_36.$$s = self, TMP_36), $c).call($d), $a = Opal.to_ary($b), id = ($a[0] == null ? nil : $a[0]), reftext = ($a[1] == null ? nil : $a[1]), $b;
            ...
            if ((($a = id['$include?']("#")) !== nil && (!$a.$$is_boolean || $a == true))) {
              $b = id.$split("#"), $a = Opal.to_ary($b), path = ($a[0] == null ? nil : $a[0]), fragment = ($a[1] == null ? nil : $a[1]), $b
              } else {
              path = nil;
              fragment = id;
            };
            if (path !== false && path !== nil) {
              ...
              if ((($a = ($b = ($c = (self.document.$references()['$[]']("ids")['$has_key?'](fragment))['$!'](), $c !== false && $c !== nil ?(((($e = (fragment['$include?'](" "))) !== false && $e !== nil) ? $e : fragment.$downcase()['$!='](fragment))) : $c), $b !== false && $b !== nil ?(resolved_id = (function() {if ((($c = $scope.get('RUBY_MIN_VERSION_1_9')) !== nil && (!$c.$$is_boolean || $c == true))) {
...
if (line == null) line = nil;
      ...
      Opal.defn(self, '$parse_quoted_text_attributes', function(str) {
        ...
        if ((($a = str['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          if ((($a = $rb_gt(segments.$length(), 1)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          if ((($a = $rb_gt(roles.$length(), 1)) !== nil && (!$a.$$is_boolean || $a == true))) {
            roles.$shift()};
          if ((($a = $rb_gt(more_roles.$length(), 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (key == null) key = nil;
        ...
        if ((($a = ($rb_minus(candidates, resolved))['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          self.$warn("asciidoctor: WARNING: invalid substitution type" + ((function() {if ((($a = $rb_gt(invalid.$size(), 1)) !== nil && (!$a.$$is_boolean || $a == true))) {
            return "s"
            } else {
            return ""
...
if (conum == null) conum = nil;
      ...
      Opal.defn(self, '$resolve_lines_to_highlight', function(spec) {
        ...
        lines = [];
        ($a = ($b = spec.$delete(" ").$split($scope.get('DataDelimiterRx'))).$map, $a.$$p = (TMP_47 = function(entry){var self = TMP_47.$$s || this, $a, $b, negate = nil, s = nil, e = nil, line_nums = nil;
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$image_uri', function(target_image, asset_dir_key) {
        ...
        if ((($a = ($b = $rb_lt(((doc = self.document)).$safe(), (($scope.get('SafeMode')).$$scope.get('SECURE'))), $b !== false && $b !== nil ?doc['$attr?']("data-uri") : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (fd == null) fd = nil;
      ...
      Opal.defn(self, '$normalize_system_path', function(target, start, jail, opts) {
        ...
        if ((($a = $rb_lt(((doc = self.document)).$safe(), (($scope.get('SafeMode')).$$scope.get('SAFE')))) !== nil && (!$a.$$is_boolean || $a == true))) {
...
Opal.modules["asciidoctor/abstract_block"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', TMP_1 = function(parent, context, opts) {
...
Opal.modules["asciidoctor/block"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', TMP_1 = function(parent, context, opts) {
        var $a, self = this, $iter = TMP_1.$$p, $yield = $iter || nil, subs = nil, raw_source = nil, $zuper = nil, $zuper_index = nil;
      ...
      Opal.defn(self, '$content', TMP_2 = function() {
        var $a, $b, $c, self = this, $iter = TMP_2.$$p, $yield = $iter || nil, $case = nil, result = nil, first = nil, last = nil, $zuper = nil, $zuper_index = nil;
        ...
        if ((($a = $rb_lt(result.$size(), 2)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return result['$[]'](0)
          } else {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$read_next_id', function() {
        ...
        if ((($a = $rb_le(self.co_index, list.$size())) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (element == null) element = nil;
      ...
      Opal.defn(self, '$next_list', function() {
        ...
        if ((($a = $rb_lt(self.lists.$size(), self.list_index)) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.lists['$<<']([])};
        self.co_index = 1;
        return nil;
      });
...
if (backend == null) backend = nil;
        ...
        return (Opal.defn(self, '$create', function(backend, opts) {
          ...
          base_converter = (function() {$case = backend;if ("defold"['$===']($case)) {if ((($a = (function(){ try { return ((((((Opal.get('Asciidoctor')).$$scope.get('Converter'))).$$scope.get('DefoldConverter'))) != null ? 'constant' : nil); } catch (err) { if (err.$$class === Opal.NameError) { return nil; } else { throw(err); }}; })()) !== nil && (!$a.$$is_boolean || $a == true))) {
            } else {
            self.$require("asciidoctor/converter/defold".$to_s())
          };
          return $scope.get('DefoldConverter').$new(backend, opts);}else if ("html5"['$===']($case)) {if ((($a = (function(){ try { return ((((((Opal.get('Asciidoctor')).$$scope.get('Converter'))).$$scope.get('Html5Converter'))) != null ? 'constant' : nil); } catch (err) { if (err.$$class === Opal.NameError) { return nil; } else { throw(err); }}; })()) !== nil && (!$a.$$is_boolean || $a == true))) {
            } else {
    ...
    (function($base) {
      ...
      (function($base) {
        ...
        Opal.defn(self, '$register_for', function() {
          var $a, $b, TMP_1, $c, TMP_2, self = this, metaclass = nil, $splat_index = nil;

          var array_size = arguments.length - 0;
          if(array_size < 0) array_size = 0;
          var backends = new Array(array_size);
          for($splat_index = 0; $splat_index < array_size; $splat_index++) {
            backends[$splat_index] = arguments[$splat_index + 0];
          }
          ...
          if (node.$doctype()['$==']("manpage")) {
            ...
            if ((($a = node['$has_header?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              ...
              if ((($a = node['$attr?']("author")) !== nil && (!$a.$$is_boolean || $a == true))) {
                ...
                if ((($a = $rb_gt((authorcount = (node.$attr("authorcount")).$to_i()), 1)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (section == null) section = nil;
        section_num = (function() {if ((($a = (($b = ($c = section.$numbered(), $c !== false && $c !== nil ?section.$caption()['$!']() : $c), $b !== false && $b !== nil ?$rb_le(section.$level(), sectnumlevels) : $b))) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          if ((($a = ($b = $rb_lt(section.$level(), toclevels), $b !== false && $b !== nil ?(child_toc_level = self.$outline(section, $hash2(["toclevels", "secnumlevels"], {"toclevels": toclevels, "secnumlevels": sectnumlevels}))) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (item == null) item = nil;
      ...
      Opal.defn(self, '$table', function(node) {
        ...
        if ((($a = $rb_gt((node.$attr("rowcount")), 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
          slash = self.void_element_slash;
          result['$<<']("<colgroup>");
          if ((($a = node['$option?']("autowidth")) !== nil && (!$a.$$is_boolean || $a == true))) {
            tag = "<col" + (slash) + ">";
...
if (l == null) l = nil;
        ...
        if ((($a = $rb_ge(self.safe, (($scope.get('SafeMode')).$$scope.get('SERVER')))) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          if ((($a = $rb_ge(self.safe, (($scope.get('SafeMode')).$$scope.get('SECURE')))) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (e == null) e = nil;
      ...
      Opal.defn(self, '$<<', TMP_10 = function(block) {
        var self = this, $iter = TMP_10.$$p, $yield = $iter || nil, $zuper = nil, $zuper_index = nil;
...
if (f == null) f = nil;
      ...
      Opal.defn(self, '$content', TMP_15 = function() {
...
Opal.modules["asciidoctor/list"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', TMP_1 = function(parent, context) {
      ...
      Opal.defn(self, '$convert', TMP_2 = function() {
        var self = this, $iter = TMP_2.$$p, $yield = $iter || nil, result = nil, $zuper = nil, $zuper_index = nil;
        ...
        if ((($b = (next_level = self['$is_next_line_section?'](reader, attributes))) !== nil && (!$b.$$is_boolean || $b == true))) {
          ...
          if ((($b = ((($c = $rb_gt(next_level, current_level)) !== false && $c !== nil) ? $c : ((($d = section.$context()['$==']("document")) ? next_level['$=='](0) : section.$context()['$==']("document"))))) !== nil && (!$b.$$is_boolean || $b == true))) {
            if ((($b = (($c = next_level['$=='](0)) ? doctype['$!=']("book") : next_level['$=='](0))) !== nil && (!$b.$$is_boolean || $b == true))) {
              ...
              self.$warn($rb_plus($rb_plus("asciidoctor: WARNING: " + (reader.$line_info()) + ": section title out of sequence: ", "expected " + ((function() {if ((($b = $rb_gt(expected_next_levels.$size(), 1)) !== nil && (!$b.$$is_boolean || $b == true))) {
                return "levels"
                } else {
                return "level"
...
if (k == null) k = nil;if (v == null) v = nil;
      ...
      Opal.defs(self, '$blockquote?', function(lines, first_line) {
        ...
        return ($a = ($b = ($c = $rb_gt(lines.$size(), 1), $c !== false && $c !== nil ?((((($d = first_line) !== false && $d !== nil) ? $d : lines['$[]'](0)))['$start_with?']("\"")) : $c), $b !== false && $b !== nil ?(lines['$[]'](-1)['$start_with?']("-- ")) : $b), $a !== false && $a !== nil ?(lines['$[]'](-2)['$end_with?']("\"")) : $a);
      });
      ...
      Opal.defs(self, '$is_delimited_block?', function(line, return_match_data) {
        ...
        if ((($a = ($b = $rb_gt((line_len = line.$length()), 1), $b !== false && $b !== nil ?($scope.get('DELIMITED_BLOCK_LEADERS')['$include?'](line['$[]']($range(0, 1, false)))) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
          return nil
        };
        if (line_len['$=='](2)) {
          ...
          if ((($a = $rb_le(line_len, 4)) !== nil && (!$a.$$is_boolean || $a == true))) {
            tip = line;
            tl = line_len;
            } else {
      ...
      Opal.defs(self, '$build_block', function(block_context, content_model, terminator, parent, reader, attributes, options) {
        ...
        if (content_model['$==']("verbatim")) {
          ...
          } else if ((($a = $rb_gt((tab_size = (((($b = attributes['$[]']("tabsize")) !== false && $b !== nil) ? $b : parent.$document().$attributes()['$[]']("tabsize"))).$to_i()), 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defs(self, '$next_outline_list', function(reader, list_type, parent) {
        ...
        } else if ((($b = $rb_lt(this_item_level, list_block.$level())) !== nil && (!$b.$$is_boolean || $b == true))) {
          break;
        } else if ((($b = $rb_gt(this_item_level, list_block.$level())) !== nil && (!$b.$$is_boolean || $b == true))) {
      ...
      Opal.defs(self, '$parse_section_title', function(reader, document) {
        ...
        if ((($a = ($b = (((($c = first_char['$==']("=")) !== false && $c !== nil) ? $c : (($d = $scope.get('Compliance').$markdown_syntax(), $d !== false && $d !== nil ?first_char['$==']("#") : $d)))), $b !== false && $b !== nil ?(match = $scope.get('AtxSectionRx').$match(line1)) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          if ((($a = ($b = ($c = ($d = ($e = (line2 = reader.$peek_line(true)), $e !== false && $e !== nil ?$scope.get('SECTION_LEVELS')['$has_key?'](line2.$chr()) : $e), $d !== false && $d !== nil ?line2['$=~']($scope.get('SetextSectionLineRx')) : $d), $c !== false && $c !== nil ?(name_match = $scope.get('SetextSectionTitleRx').$match(line1)) : $c), $b !== false && $b !== nil ?$rb_le(($rb_minus(self.$line_length(line1), self.$line_length(line2))).$abs(), 1) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            single_line = false;
            reader.$advance();}};
        if ((($a = $rb_ge(sect_level, 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (key == null) key = nil;if (val == null) val = nil;
        ...
        if (document !== false && document !== nil) {
          ...
          if ((($a = ($d = document.$attributes()['$has_key?']("author"), $d !== false && $d !== nil ?((author_line = document.$attributes()['$[]']("author")))['$!='](implicit_author) : $d)) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            } else if ((($a = $rb_gt(authors.$size(), 1)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (key == null) key = nil;
          ...
          if (names_only !== false && names_only !== nil) {
            if ((($a = $rb_gt(((segments = author_entry.$split(" "))).$size(), 3)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (option == null) option = nil;
      ...
      Opal.defs(self, '$adjust_indentation!', function(lines, indent, tab_size) {
        ...
        if ((($a = lines['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return nil};
        if ((($a = ($b = $rb_gt((tab_size = tab_size.$to_i()), 0), $b !== false && $b !== nil ?(lines.$join()['$include?']($scope.get('TAB'))) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (i == null) i = nil;
        digit = digits['$[]'](value['$[]']($range(i, i, false)));
          if ((($a = ($b = $rb_lt($rb_plus(i, 1), value.$length()), $b !== false && $b !== nil ?$rb_gt(digits['$[]'](value['$[]']($range($rb_plus(i, 1), $rb_plus(i, 1), false))), digit) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (segment == null) segment = nil;
        if (segment['$==']($scope.get('DOT_DOT'))) {
            if (jail !== false && jail !== nil) {
              if ((($a = $rb_gt(resolved_segments.$length(), jail_segments.$length())) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (line == null) line = nil;
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', TMP_5 = function(document, data, cursor) {
        ...
        if ((($a = $rb_lt(include_depth_default, 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defn(self, '$prepare_lines', TMP_6 = function(data, opts) {
        var $a, $b, $c, self = this, $iter = TMP_6.$$p, $yield = $iter || nil, result = nil, front_matter = nil, first = nil, last = nil, $zuper = nil, $zuper_index = nil;
      ...
      Opal.defn(self, '$peek_line', TMP_7 = function(direct) {
        var $a, self = this, $iter = TMP_7.$$p, $yield = $iter || nil, line = nil, $zuper = nil, $zuper_index = nil;
      ...
      Opal.defn(self, '$preprocess_conditional_inclusion', function(directive, target, delimiter, text) {
        ...
        if (directive['$==']("endif")) {
          ...
          if ((($a = $rb_gt(stack_size, 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (candidate == null) candidate = nil;
        return candidate.$instance()['$handles?'](target)}, TMP_12.$$s = self, TMP_12), $c).call($d)) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          return true;
        } else if ((($a = $rb_ge(self.document.$safe(), (($scope.get('SafeMode')).$$scope.get('SECURE')))) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$replace_next_line("link:" + (target) + "[]");
          return true;
        } else if ((($a = ($b = $rb_gt((abs_maxdepth = self.maxdepth['$[]']("abs")), 0), $b !== false && $b !== nil ?$rb_ge(self.include_stack.$size(), abs_maxdepth) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.$warn("asciidoctor: ERROR: " + (self.$line_info()) + ": maximum include depth of " + (self.maxdepth['$[]']("rel")) + " exceeded");
          return false;
        } else if ((($a = $rb_gt(abs_maxdepth, 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
          if ((($a = Opal.get('RUBY_ENGINE_OPAL')) !== nil && (!$a.$$is_boolean || $a == true))) {
            target_type = "file";
          ...
          if ((($a = raw_attributes['$empty?']()['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            if ((($a = attributes['$has_key?']("lines")) !== nil && (!$a.$$is_boolean || $a == true))) {
              inc_lines = [];
              ($a = ($b = attributes['$[]']("lines").$split($scope.get('DataDelimiterRx'))).$each, $a.$$p = (TMP_13 = function(linedef){var self = TMP_13.$$s || this, $a, $b, $c, $d, from = nil, to = nil;
if (linedef == null) linedef = nil;
              if ((($a = linedef['$include?']("..")) !== nil && (!$a.$$is_boolean || $a == true))) {
                  $b = ($c = ($d = linedef.$split("..")).$map, $c.$$p = "to_i".$to_proc(), $c).call($d), $a = Opal.to_ary($b), from = ($a[0] == null ? nil : $a[0]), to = ($a[1] == null ? nil : $a[1]), $b;
                  if (to['$=='](-1)) {
                    inc_lines['$<<'](from);
...
if (tag == null) tag = nil;
              ...
              if ((($a = ((missing_tags = $rb_minus(tags.$to_a(), tags_found.$to_a())))['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
                ...
                self.$warn("asciidoctor: WARNING: " + (self.$line_info()) + ": tag" + ((function() {if ((($a = $rb_gt(missing_tags.$size(), 1)) !== nil && (!$a.$$is_boolean || $a == true))) {
                  return "s"
                  } else {
                  return nil
...
if (f == null) f = nil;
      ...
      Opal.defn(self, '$push_include', function(data, file, path, lineno, attributes) {
        ...
        if ((($a = attributes['$has_key?']("depth")) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          if ((($a = $rb_le(depth, 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
            depth = 1};
      ...
      Opal.defn(self, '$pop_include', function() {
        ...
        if ((($a = $rb_gt(self.include_stack.$size(), 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defn(self, '$exceeded_max_depth?', function() {
        ...
        if ((($a = ($b = $rb_gt((abs_maxdepth = self.maxdepth['$[]']("abs")), 0), $b !== false && $b !== nil ?$rb_ge(self.include_stack.$size(), abs_maxdepth) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defn(self, '$shift', TMP_20 = function() {
        var $a, self = this, $iter = TMP_20.$$p, $yield = $iter || nil, $zuper = nil, $zuper_index = nil;
...
Opal.modules["asciidoctor/section"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$<<', TMP_2 = function(block) {
      ...
      return (Opal.defn(self, '$to_s', TMP_3 = function() {
        var $a, self = this, $iter = TMP_3.$$p, $yield = $iter || nil, qualified_title = nil, $zuper = nil, $zuper_index = nil;
...
if (col == null) col = nil;
      ...
      return (Opal.defn(self, '$partition_header_footer', function(attributes) {
        ...
        if ((($a = ($b = $rb_gt(num_body_rows, 0), $b !== false && $b !== nil ?self.has_header_option : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (c == null) c = nil;
        ...
        if ((($a = ($c = $rb_gt(num_body_rows, 0), $c !== false && $c !== nil ?attributes['$key?']("footer-option") : $c)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (p == null) p = nil;
      ...
      return (Opal.defn(self, '$to_s', TMP_9 = function() {
        var $a, self = this, $iter = TMP_9.$$p, $yield = $iter || nil, $zuper = nil, $zuper_index = nil;
      ...
      Opal.defn(self, '$load', function(input, options) {
        ...
        options = options.$dup();
          ...
          attributes = options['$[]=']("attributes", (function() {if ((($a = ((attrs = options['$[]']("attributes")))['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            return ($a = ($b = attrs).$inject, $a.$$p = (TMP_2 = function(accum, entry){var self = TMP_2.$$s || this, $a, $b, k = nil, v = nil;
if (accum == null) accum = nil;if (entry == null) entry = nil;
            $b = entry.$split("=", 2), $a = Opal.to_ary($b), k = ($a[0] == null ? nil : $a[0]), v = ($a[1] == null ? nil : $a[1]), $b;
            ...
            return ($a = ($c = attrs.$split($scope.get('NULL'))).$inject, $a.$$p = (TMP_3 = function(accum, entry){var self = TMP_3.$$s || this, $a, $b, k = nil, v = nil;
if (accum == null) accum = nil;if (entry == null) entry = nil;
            $b = entry.$split("=", 2), $a = Opal.to_ary($b), k = ($a[0] == null ? nil : $a[0]), v = ($a[1] == null ? nil : $a[1]), $b;
              accum['$[]='](k, ((($a = v) !== false && $a !== nil) ? $a : ""));
...
if (key == null) key = nil;
      ...
      Opal.defn(self, '$convert', function(input, options) {
        ...
        if (write_to_same_dir !== false && write_to_same_dir !== nil) {
          ...
          jail = (function() {if ((($a = $rb_ge(doc.$safe(), (($scope.get('SafeMode')).$$scope.get('SAFE')))) !== nil && (!$a.$$is_boolean || $a == true))) {
            return working_dir
            } else {
            return nil
          }; return nil; })();
        ...
        if (outfile !== false && outfile !== nil) {
          ...
          if ((($a = ($b = ($c = ($d = ($e = ($f = stream_output['$!'](), $f !== false && $f !== nil ?$rb_lt(doc.$safe(), (($scope.get('SafeMode')).$$scope.get('SECURE'))) : $f), $e !== false && $e !== nil ?(doc['$attr?']("linkcss")) : $e), $d !== false && $d !== nil ?(doc['$attr?']("copycss")) : $d), $c !== false && $c !== nil ?(doc['$attr?']("basebackend-html")) : $c), $b !== false && $b !== nil ?(($c = (stylesdir = (doc.$attr("stylesdir"))), $c !== false && $c !== nil ?($scope.get('Helpers')['$uriish?'](stylesdir)) : $c))['$!']() : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            if ((($a = ((($b = ((($c = ((($d = copy_asciidoctor_stylesheet) !== false && $d !== nil) ? $d : copy_user_stylesheet)) !== false && $c !== nil) ? $c : copy_coderay_stylesheet)) !== false && $b !== nil) ? $b : copy_pygments_stylesheet)) !== nil && (!$a.$$is_boolean || $a == true))) {
              stylesoutdir = doc.$normalize_system_path(stylesdir, outdir, (function() {if ((($a = $rb_ge(doc.$safe(), (($scope.get('SafeMode')).$$scope.get('SAFE')))) !== nil && (!$a.$$is_boolean || $a == true))) {
                return outdir
                } else {
                return nil
              }; return nil; })());
              ...
              if (copy_asciidoctor_stylesheet !== false && copy_asciidoctor_stylesheet !== nil) {
                ...
                stylesheet_dst = doc.$normalize_system_path(stylesheet, stylesoutdir, ((function() {if ((($a = $rb_ge(doc.$safe(), (($scope.get('SafeMode')).$$scope.get('SAFE')))) !== nil && (!$a.$$is_boolean || $a == true))) {
                  return outdir
                  } else {
                  return nil
                }; return nil; })()));
...
args = $slice.call(arguments, 0);
      ...
      (function($base) {
        ...
        Opal.defn(self, '$process', TMP_3 = function() {
          var $a, self = this, $iter = TMP_3.$$p, block = $iter || nil, $splat_index = nil;
...
if (group == null) group = nil;
        ...
        Opal.defn(self, '$treeprocessor', TMP_10 = function() {
          var $a, $b, self = this, $iter = TMP_10.$$p, block = $iter || nil, $splat_index = nil;
        ...
        Opal.defn(self, '$postprocessor', TMP_11 = function() {
          var $a, $b, self = this, $iter = TMP_11.$$p, block = $iter || nil, $splat_index = nil;
        ...
        Opal.defn(self, '$include_processor', TMP_12 = function() {
          var $a, $b, self = this, $iter = TMP_12.$$p, block = $iter || nil, $splat_index = nil;
        ...
        Opal.defn(self, '$docinfo_processor', TMP_13 = function() {
          var $a, $b, self = this, $iter = TMP_13.$$p, block = $iter || nil, $splat_index = nil;
...
if (ext == null) ext = nil;
        ...
        Opal.defn(self, '$block_macro', TMP_17 = function() {
          var $a, $b, self = this, $iter = TMP_17.$$p, block = $iter || nil, $splat_index = nil;
        ...
        Opal.defn(self, '$inline_macro', TMP_18 = function() {
          var $a, $b, self = this, $iter = TMP_18.$$p, block = $iter || nil, $splat_index = nil;
...
if (word == null) word = nil;
        ...
        Opal.defn(self, '$resolve_args', function(args, expect) {
          ...
          if (expect['$=='](1)) {
            return opts};
          num_args = args.$size();
          if ((($a = $rb_gt((missing = $rb_minus($rb_minus(expect, 1), num_args)), 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
            args.$fill(nil, num_args, missing)
          } else if ((($a = $rb_lt(missing, 0)) !== nil && (!$a.$$is_boolean || $a == true))) {
            args.$pop(missing['$-@']())};
          args['$<<'](opts);
          return args;
        });
      ...
      (function(self) {
        ...
        Opal.defn(self, '$register', TMP_24 = function() {
          var $a, self = this, $iter = TMP_24.$$p, block = $iter || nil, argc = nil, resolved_group = nil, group = nil, $case = nil, name = nil, $splat_index = nil;
