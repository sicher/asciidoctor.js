...
Opal.modules["emoji-inline-macro/extension"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    return (Opal.defn(self, '$handle_stylesheet', function(doc, extdir, stylesheet_name) {
      ...
      stylesoutdir = doc.$normalize_system_path((doc.$attr("stylesdir")), outdir, ((function() {if ((($a = $rb_ge(doc.$safe(), (($scope.get('SafeMode')).$$scope.get('SAFE')))) !== nil && (!$a.$$is_boolean || $a == true))) {
        return outdir
        } else {
        return nil
      }; return nil; })()));
      if ((($a = ($b = ($c = stylesoutdir['$!='](extdir), $c !== false && $c !== nil ?$rb_lt(doc.$safe(), (($scope.get('SafeMode')).$$scope.get('SECURE'))) : $c), $b !== false && $b !== nil ?(doc['$attr?']("copycss")) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
        destination = doc.$normalize_system_path(stylesheet_name, stylesoutdir, ((function() {if ((($a = $rb_ge(doc.$safe(), (($scope.get('SafeMode')).$$scope.get('SAFE')))) !== nil && (!$a.$$is_boolean || $a == true))) {
          return outdir
          } else {
          return nil
        }; return nil; })()));
